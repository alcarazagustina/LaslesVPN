...
const NavBar = () => {
    ...
    return (
        <div className="container mx-auto max-w pt-5">
            <nav className="p-4 flex flex-col md:flex-row items-center justify-between">
                <div className="flex">
                    ...
                    <div className="flex items-center">
                        <span onClick={ocultarMenu} className="md:hidden ">
                            <img src={menu ? "src/assets/x.svg" : "src/assets/menu.svg"} alt="" />
                        </span>
                    </div>
                </div>

                <ul className={`flex ${menu ? "block" : "hidden"} md:flex flex-col md:flex-row items-center space-x-0 md:space-x-8 space-y-2 md:space-y-0 text-[#4F5665]`}>
                ...
                <div className={`flex ${menu ? "block" : "hidden"} md:flex flex-col md:flex-row items-center space-x-0 md:space-x-4 space-y-2 md:space-y-0 `}>
                    ...
                    <button className="text-base button-color-basic font-semibold border border-[#F53855] px-4 py-2 rounded-full cursor-pointer pl-5 pr-5 hover-[#F53855]">
                        Sign Up
                    </button>
                </div>
            </nav>
