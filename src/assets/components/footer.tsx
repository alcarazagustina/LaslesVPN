            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 pl-10 pr-10">
                <div className="col-span-2  p-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <h2 className="text-black font-semibold text-xl ml-2">Lasles<span className="font-bold">VPN</span></h2>
                    </div>

                    <p className="mt-9 text-[#4F5665] text-base">
                    ...
                    <p className="text-sm text-slate-500">©2023LaslesVPN</p>
                ...
                <div className="col-span-1 p-4">
                    ...
                    <ul className="text-base text-[#4F5665] mt-10">
                ...
                <div className="col-span-1 p-4">
                    ...
                    <ul className="text-base text-[#4F5665] mt-8">
